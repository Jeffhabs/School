...
enum MachineState {
    ...
    LPAREN_STATE, RPAREN_STATE, LCURLY_STATE, RCURLY_STATE, BAD_STATE, ALMOST_NOT_EQUAL_STATE, END_OF_FILE_STATE, LAST_STATE
};
...
enum CharacterType {
    ...
    PIPE_CHAR, EXPONENT_CHAR, NEW_LINE_CHAR, BANG_CHAR, END_OF_FILE_CHAR, LAST_CHAR
};
